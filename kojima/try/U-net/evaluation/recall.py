...
def evalution(t_img , a_img):
    ...
    back = back_accuracy/back_all                   #背景の再現率
    nuclear = nuclear_accuracy/nuclear_all          #核の再現率
    cytoplasm = cytoplasm_accuracy/cytoplasm_all    #細胞質の再現率

    final_recall = (back + nuclear + cytoplasm)/3 # 再現率のマクロ平均
    #print(args[1])
    #print("back:", back)
    #print("nuclear:", nuclear)
    #print("cytoplasm:", cytoplasm)
    print("再現率:"+str(final_recall))
    #print("")
#------------------main--------------------#
args = sys.argv
