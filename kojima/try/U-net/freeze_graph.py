...
--output_graph=model/cell_final.pb \
--output_node_names=output/BiasAdd \
--input_binary=False

できるファイル
cheakpoint 
deploy.ckpt.data-00000-of0001
deploy.ckpt.index
deploy.ckpt.meta
deployfinal.ckpt.data-00000-of0001
deployfinal.ckpt.index
deployfinal.ckpt.meta
.pbのファイル(これがモデル)
semanticsegmentation_person.pbtxt
...
# from tf.python import pywrap_tensorflow
